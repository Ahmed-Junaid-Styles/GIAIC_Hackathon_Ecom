...
const After_header = (props: any) => {
    return (
        <div>
            <div className='bg-violet-100 h-[12vw] flex items-center'>
            ...
            {
                props.eccomerce && 
                <div className='w-9/12 mx-auto flex justify-between items-center h-[10vw]'>
                            <div className='flex flex-col'>
                                <div className='font-semibold text-blue-800 text-2xl'>Eccomerce acceories & Fashion item</div>
                            ...
                            <div className='flex mx-4'>
                                ...
                                <div className='flex mx-4'>
                                    <div>Sort By:</div>
                                    <div><input type="text" className='border-2 w-28 mx-2 px-3' placeholder='Best Match' /></div>
                                </div>
