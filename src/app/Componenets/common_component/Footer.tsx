        ...
        <div className='bg-violet-200 '>
          <div className='lg:w-9/12 mx-auto flex vsm:flex-col lg:flex-row vsm:w-[70%] py-16'>
            ...
            <div className='flex flex-col flex-grow-[1]'>
              ...
              <div className='my-2 text-blue-800 font-semibold opacity-40'>Orders History</div>
            ...
            <div className='flex flex-col flex-grow-[1]'>
              ...
              <div className='my-2 text-blue-800 font-semibold opacity-40'>Pre-Built Pages</div>
              <div className='my-2 text-blue-800 font-semibold opacity-40'>Visual Composer Elements</div>
              <div className='my-2 text-blue-800 font-semibold opacity-40'>WooCommerce Pages</div>

            </div>
          </div>
        </div>
        <div className='bg-purple-100 h-14 flex justify-around items-center'>
