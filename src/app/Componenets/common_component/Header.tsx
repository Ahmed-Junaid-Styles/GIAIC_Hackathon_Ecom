...
const Header = () => {
    return (
        <div className=''>
            <header className=''>
                <nav className='lg:w-[] lap:h-12 bg-purple-500 lap:flex lap:justify-around items-center text-white vsm:w-[100%] vsm:py-3'>
                    <div className=' flex lg:w-[] lg:justify-center lap:mx-1 vsm:mx-auto vsm:justify-center'>
                    ...
                    <div className='lg:w-[20%] flex lg:justify-between items-center vsm:justify-evenly'>
                        <div className=''>
